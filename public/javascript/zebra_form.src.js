    ...
    $.Zebra_Form = function(element, options) {
        ...
        plugin.init = function() {
            ...
            elements.each(function() {
                ...
                if ((attributes['type'] == 'text' || attributes['type'] == 'password') && element.data('prefix')) {
                    ...
                    var
                        ...
                        match = decodeURIComponent(prefix.replace(/\+/g, ' ')).match(/^images\:(.*)/i),
                    ...
                    if (is_image)
                        ...
                        // create an <images> tag with the specified "src"
                        $prefix = jQuery('<images>', {
                            'src': match[1]
                        });
            ...
            if ($captcha_container.length > 0) {
                ...
                var $image = $('images', $captcha_container),
